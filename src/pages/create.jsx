...
function handleChange(e) {
	...
	/*la funcion handleOnChangeFile sirve para decodificar una imagen en javascript
	una imagen de libro en la app*/
			...
			<form onSubmit={handleSubmit} style={inputStyles.formContainer}>
				...
				<div>
					<div>
						...
						width="200" alt="preview"/> : ""}</div>
					</div>
					<div>

					</div>
					<div style={inputStyles.title}>Intoduction</div>
